...
class Artefact(Base):
    ...
    id_artefact = Column(String(255), primary_key=True, default=uuid.uuid4)
...
class Espece(Base):
    ...
    id_espece = Column(String(255), primary_key=True, default=uuid.uuid4)
    nom = Column(String(255), nullable=True)
...
class EtatMonde(Base):
    ...
    id_etat = Column(String(255), primary_key=True, default=uuid.uuid4)
...
class Evenement(Base):
    ...
    id_evenement = Column(String(255), primary_key=True, default=uuid.uuid4)
    nom = Column(String(255), nullable=True)
    description = Column(String(255), nullable=True)
    annee_id = Column(String(255), ForeignKey('annee.id_annee'))
    datajoutserver = Column(String(255), nullable=True)
...
class Interaction(Base):
    ...
    id_interaction = Column(String(255), primary_key=True, default=uuid.uuid4)
...
class InteractionPersonnage(Base):
    ...
    id_interaction_personnage = Column(String(255), primary_key=True, default=uuid.uuid4)
...
class Lieu(Base):
    ...
    id_lieu = Column(String(255), primary_key=True, default=uuid.uuid4)
    nom = Column(String(255), nullable=True)
    description = Column(String(255), nullable=True)
...
class Oeuvre(Base):
    ...
    id_oeuvre = Column(String(255), primary_key=True, default=uuid.uuid4)
    nom = Column(String(255), nullable=True)
    type = Column(String(255), nullable=True)
...
class Panier(Base):
    ...
    id_panier = Column(String(255), primary_key=True, default=uuid.uuid4)
...
class Parametre(Base):
    ...
    id_parametre = Column(String(255), primary_key=True, default=uuid.uuid4)
    nom = Column(String(255), nullable=True)
...
class Personnage(Base):
    ...
    id_personnage = Column(String(255), primary_key=True, default=uuid.uuid4)
    nom = Column(String(255), nullable=True)
...
class PersonnageArtefact(Base):
    ...
    id_personnage_artefact = Column(String(255), primary_key=True, default=uuid.uuid4)
    personnage_id = Column(String(255), ForeignKey('personnage.id_personnage'))
...
class PersonnagePouvoir(Base):
    ...
    personnage_id = Column(String(255), ForeignKey('personnage.id_personnage'), primary_key=True, default=uuid.uuid4)
...
class PersonnageRelation(Base):
    ...
    id_personnage_relation = Column(String(255), primary_key=True, default=uuid.uuid4)
...
class Pouvoir(Base):
    ...
    id_pouvoir = Column(String(255), primary_key=True, default=uuid.uuid4)
    nom = Column(String(255), nullable=True)
    description = Column(String(255), nullable=True)
    datajoutserver = Column(String(255), nullable=True)
    effacer = Column(String(255), nullable=True)
...
class Produit(Base):
    ...
    id_produit = Column(String(255), primary_key=True, default=uuid.uuid4)
    nom = Column(String(255), nullable=True)
...
class ProduitsDansPanier(Base):
    ...
    id_produit_panier = Column(String(255), primary_key=True, default=uuid.uuid4)
...
class Race(Base):
    ...
    id_race = Column(String(255), primary_key=True, default=uuid.uuid4)
    nom = Column(String(255), nullable=True)
    description = Column(String(255), nullable=True)
    datajoutserver = Column(String(255), nullable=True)
    effacer = Column(String(255), nullable=True)
...
class Relation(Base):
    ...
    id_relation = Column(String(255), primary_key=True, default=uuid.uuid4)
...
class Ressource(Base):
    ...
    id_ressource = Column(String(255), primary_key=True, default=uuid.uuid4)
    nom = Column(String(255), nullable=True)
...
class Utilisateur(Base):
    ...
    id_utilisateur = Column(String(255), primary_key=True, default=uuid.uuid4)
    nom = Column(String(255), nullable=True)
...
class Role(Base):
    __tablename__ = 'role'
    id_role = Column(String(255), primary_key=True, default=uuid.uuid4)
    nom = Column(String(255), nullable=True)
    description = Column(String(255), nullable=True)
    datajoutserver = Column(String(255), nullable=True)
    effacer = Column(String(255), nullable=True)
...
class UtilisateurRole(Base):
    ...
    id_utilisateur_role = Column(String(255), primary_key=True, default=uuid.uuid4)
...
class Permission(Base):
    ...
    id_permission = Column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    nom = Column(String(255), nullable=True)
    description = Column(String(255), nullable=True)

class RolePermission(Base):
    __tablename__ = 'role_permission'
    id_role_permission = Column(String(255), primary_key=True, default=uuid.uuid4)
    id_role = Column(String(255), ForeignKey('role.id_role'), nullable=False)
    id_permission = Column(String(255), ForeignKey('permission.id_permission'), nullable=False)
